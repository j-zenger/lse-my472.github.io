...
```{r}
table_raw <- print(tables[3]) # position 3 happens to be the correct table (checked 29/10/2024)
```
...
```{r}
table_raw <- html_elements(html, css = "sortable wikitable sticky-header-multi static-row-numbers sort-under col1left col2center")
print(table_raw) # now a list of length 1
```

...
```{r}
all_caption_elements <- html_noether %>% html_elements(css = ".mw-default-size")
...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = ".mw-default-size.mw-halign-left")
